        ...
        <div className="glass-panel p-10 mb-12 w-full shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 p-6 rounded-xl border border-white/10 hover:border-orange-400/30 transition shadow-lg">
              <h3 className="text-orange-400 font-bold mb-2">Advanced Reporting & Omni-Search</h3>
              <p className="text-sm text-white/60 mb-3">Admins have access to a dynamic Compliance Risk Heatmap, calculating real-time load distribution by cross-referencing AI priority scores with departmental assignment. Additionally, Admins can utilize the Global Omni-Search engine to filter large queues by text snippet or ID, and generate CSV compliance reports directly from the DOM.</p>
              <div className="bg-black/50 p-3 rounded border border-white/5 text-xs text-white/40 font-mono">
